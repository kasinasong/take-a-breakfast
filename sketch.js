...
scale=scaleSlider.value();  
 ...
 //fried egg icon hover
  ...
  //acaibowl hover
    if(mouseX > 65 && mouseX < 110 && mouseY > 135+60 && mouseY < 135+50+60){
  image(acaibowl, 90,160+60,60,60)}
  
  //mcmuffin hover
    if(mouseX > 135 && mouseX < 185 && mouseY > 135+60 && mouseY < 135+50+60){
  image(mcmuffin, 160,160+60,60,60)}
  
   //avocado hover
    if(mouseX > 65 && mouseX < 110 && mouseY > 135+60+60 && mouseY < 135+50+60+60){
  image(avocado, 90,160+120,60,60)}
  
    //salapao hover
    if(mouseX > 135 && mouseX < 185 && mouseY > 135+60+60 && mouseY < 135+50+60+60){
  image(salapao, 160,160+120,70,70)}
  
    //platonggo hover
    if(mouseX > 65 && mouseX < 110 && mouseY > 135+60+60+60 && mouseY < 135+50+60+60+60){
  image(platonggo, 90,160+120+60,90,90)}
  
  //sushi hover
    if(mouseX > 135 && mouseX < 185 && mouseY > 135+60+60+60 && mouseY < 135+50+60+60+60){
  image(sushi, 160,160+120+60,60,60)}
  
  //hashbrown hover
    if(mouseX > 65 && mouseX < 110 && mouseY > 135+60+60+60+60 && mouseY < 135+50+60+60+60+60){
  image(hashbrown, 90,160+120+120,50,50)}
  
   //tomato hover
    if(mouseX > 135 && mouseX < 185 && mouseY > 135+60+60+60+60 && mouseY < 135+50+60+60+60+60){
...
//plate selection
  ...
  push();
//plate1 hover
 if(mouseX > width-155 && mouseX < width-105 && mouseY > 85 && mouseY < 135){
  noFill();
  stroke('#F44336');
  strokeWeight(4);
  circle(width-130,110,50,50); }
...
//plate2 hover
   if(mouseX > width-155 && mouseX < width-105 && mouseY > 180-25 && mouseY < 180+25){
  noFill();
  stroke('#F44336');
  strokeWeight(4);
  circle(width-130,180,50,50);}
...
//plate3 hover
   if(mouseX > width-155 && mouseX < width-105 && mouseY > 250-25 && mouseY < 250+25){
  noFill();
  stroke('#F44336');
  strokeWeight(4);
  circle(width-130,250,50,50);}
...
//plate4 hover
   if(mouseX > width-155 && mouseX < width-105 && mouseY > 320-25 && mouseY < 320+25){
  noFill();
  stroke('#F44336');
  strokeWeight(4);
  circle(width-130,320,50,50);}
...
//plate5 hover / none
   if(mouseX > width-155 && mouseX < width-105 && mouseY > 390-25 && mouseY < 390+25){
  noFill();
  stroke('#F44336');
  strokeWeight(4);
  circle(width-130,390,50,50);}
...
//click on acaibowl
   if (mouseX > 55 && mouseX < 105 && mouseY > 135+60 && mouseY < 135+50+60) {
    d=3;}
...
function changeplate(){
  if (p==1){image(plate1,width/2,height/2,height,height);
  noFill();
  strokeWeight(4);
  circle(width-130,110,50,50); 
  
}else if(p==2){image(plate2,width/2,height/2,height,height);
  noFill();
  strokeWeight(4);
  circle(width-130,180,50,50);
               
}else if(p==3){image(plate3,width/2,height/2,height,height);
  noFill();
  strokeWeight(4);
  circle(width-130,250,50,50);

}else if(p==4){image(plate4,width/2,height/2,height,height);
  noFill();
  strokeWeight(4);
  circle(width-130,320,50,50);
